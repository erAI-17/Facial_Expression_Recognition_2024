...
class EmotionRecognition(tasks.Task, ABC):
    def __init__(self, 
        ...
        if args.train.loss_fn == 'CE':
            ...
            self.feat_dim = 768 if args.models['FUSION'].model == 'FusionNet' or args.models['FUSION'].model == 'FusionNetWithPretrainedViT' else 352*2 if args.models['FUSION'].model == 'FusionNet_NOTRANSF_onlylate' else 352
